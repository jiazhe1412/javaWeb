...
public class ProductInformation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Product productInfo = productService.findProductById(productID);

            Product storeProductID = new Product(productID);

            DiscountService discountService = new DiscountService(em);
            List<Discount> discountInfo = discountService.findDiscountByProductID(storeProductID);
